...
public class Tasks
{
    ...
    public void task1(int inputMode)
    {
        ...
        {
            try {
            String path = "rc/task_1_data.txt";
            ...
            {
                logger.fatal("Файл \"task_1_data\" отсутствует");
            }
        }
        result = x * Math.log(x) + y/(Math.cos(x)-x/3);
        System.out.println("Результат: " + result);
        logger.debug("task1 закончил работу");
    }
    ...
    public void task2(int inputMode)
    {
        ...
        {
            try {
            String path = "src/task_2_data.txt";
            Scanner scanner = new Scanner(new File(path));
            x = scanner.nextDouble();
            System.out.println("Ввод из файла, x = " + x);}
            catch (IOException e)
            {
                logger.fatal("Файл \"task_2_data\" отсутствует");
            }
        }
        double x2 = x * x;
        double x4 = x2 * x2;
        ...
        logger.info("какая-то информация о задании");
    }
    ...
    public void task3(int inputMode)
    {
        ...
        {
            try {
                String path = "src/task_3_data.txt";
                Scanner scanner = new Scanner(new File(path));
            ...
            {
                logger.fatal("Файл \"task_3_data\" отсутствует");
            }
        }
        int count = 0;
    ...
    public void task4(int inputMode)
    {
        ...
        {
            try {
                String path = "src/task_4_data.txt";
                Scanner scanner = new Scanner(new File(path));
                a = scanner.nextDouble();
            ...
            {
                logger.fatal("Файл \"task_4_data\" отсутствует");
            }
        }
        ...
        {
            logger.error("Треугольник нельзя построить");
        }
    }
    ...
    public void task5(int inputMode)
    {
        ...
        {
            try {
                String path = "src/task_5_data.txt";
                Scanner scanner = new Scanner(new File(path));
                N = scanner.nextInt();
            ...
            {
                logger.fatal("Файл \"task_5_data\" отсутствует");
            }
        }
        int remainder = N % 4;
        double k = N/4;
    ...
    public void task6(int inputMode)
    {
        ...
        {
            try {
                String path = "src/task_6_data.txt";
                Scanner scanner = new Scanner(new File(path));
                N = scanner.nextInt();
                System.out.println("Ввод  натурального число N из файла, N = " + N);
            }
            ...
            {
                logger.fatal("Файл \"task_6_data\" отсутствует");
            }
        }
        for (int a = 1; a < N; a++)
        {
    ...
    public void task7(int inputMode)
    {
        ...
        {
            try {
            String path = "src/task_7_data.txt";
            Scanner scanner = new Scanner(new File(path));
            n = scanner.nextInt();
            ...
            {
                logger.fatal("Файл \"task_7_data\" отсутствует");
            }
        }
        for (int i = 1; i <= n; i++)
        {
    ...
    public void task8(int inputMode) throws FileNotFoundException, ParseException {
        ...
        {
            Scanner scanner = new Scanner(new File("src/task_8_data.txt"));
            startDay = formater.parse(scanner.nextLine());
            time = startDay.getTime();
